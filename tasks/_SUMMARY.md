# Folder Summary: MetaHarvest/tasks

## Purpose
This folder stores explicit future-task artifacts for MetaHarvest-owned work that has been identified but not implemented.

## Contains
<!-- PROJECTFORGE:BEGIN-CONTAINS -->
- `T-20260619-library-discoverability-backfill.md`
- `T-20260619-minimal-first-class-relationship-index.md`
